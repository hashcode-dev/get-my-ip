    ...
    <div className="min-h-[100dvh] flex flex-col bg-background text-foreground font-sans">
      ...
      <main className="flex-1 mx-auto w-full max-w-2xl px-6 py-12 flex flex-col gap-6">
        ...
        <p className="text-muted-foreground leading-relaxed">
          MyIPAddress is a free, fast, and reliable tool that helps you instantly discover your public IP address along with detailed network information including your location, ISP, timezone, and more.
        </p>
        <p className="text-muted-foreground leading-relaxed">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Thank you for using MyIPAddress. If you have feedback or suggestions, feel free to reach out via our <Link href="/contact" className="text-primary hover:underline">Contact page</Link>.
        </p>
      </main>
